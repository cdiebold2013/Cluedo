            ...
            while (true) {
                try {
                    ...
                    if (clueMsg == null) {
                        ...
                        int type  = clueMsg.getType();
                        switch(type){
                            case ClueLessMsg.STARTSETTING:
                                //get the ClueLessMsg object's playerID and cards
                                break;

                            case ClueLessMsg.GAMEHISTORY:
                                //update the GUI
                                break;
                            case ClueLessMsg.YOURTURN:
                                //update the GUI
                                break;
                            case ClueLessMsg.YOURTURNTODISPROVE:
                                //update the GUI
                                break;
                            case ClueLessMsg.END:
                                break;
